...
public class Lab5_35_39_Server {
    ...
    public static int hammingDistance(String a, String b) {
        int distance = 0;
        System.out.print("Error at bit positions: ");
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Original Codeword: " + originalCodeword);
            ...
            if (remainder.contains("1")) {
                ...
                System.out.println("Total bit errors (Hamming Distance): " + errorCount);
            } else {
